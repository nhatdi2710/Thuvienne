...
/*Thêm 10 quyển sách*/
insert into sach(ma_sach, stt_theloai, ma_nxb, ma_tg, ten_sach, tgxb) values (110, 01, '001', 'TG001', 'Dế Mèn phiêu lưu ký' ,1941-11-03);
...
insert into tk_quantrivien(username_qtv, ten_loai, ten_qtv, email_qtv, ngay_sinh, password_qtv) values ('admin1', 'quantv', 'Nhat Duy', 'admin@gmail.com', '2003-10-27', '1');
select * from tk_quantrivien;

#Thêm Tài Khoản Độc Giả
insert into tk_docgia(username_dg, ten_loai, ten_dg, email_dg, ngaysinh_dg, password_dg) values ('user1', 'nguoidung', 'Hai Dang', 'toitenla@gmail.com', '2003-8-10', '1');
